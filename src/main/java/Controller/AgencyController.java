...
public class AgencyController {
    ...
    private class AddVacationAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            agencyPage.setSelectDestForVacation(generator.generateTable(systemService.selectDestination()));
    ...
    private class ViewVacationAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            agencyPage.setVacationTable(generator.generateTable(agencyService.viewVacation()));
        }
    }
    ...
    private class DeleteDestinationAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            generator = new DestinationGenerator();
            agencyPage.setDestinationTableForDelete(generator.generateTable(systemService.selectDestination()));
    ...
    private class DeleteVacationAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            generator = new VacationGenerator();
            agencyPage.setVacationTableForDelete(generator.generateTable(agencyService.viewVacation()));
    ...
    private class MiddleEditVacationAction implements MouseListener {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            generator = new DestinationGenerator();
            JTable table = generator.generateTable(systemService.selectDestination());
    ...
    private class EditVacationAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            generator = new VacationGenerator();
            JTable table = generator.generateTable(agencyService.viewVacation());
